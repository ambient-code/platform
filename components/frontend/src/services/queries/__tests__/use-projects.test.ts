...
describe('projectKeys', () => {
  ...
  it('generates correct query keys', () => {
    expect(projectKeys.all).toEqual([BACKEND_VERSION, 'projects']);
    expect(projectKeys.lists()).toEqual([BACKEND_VERSION, 'projects', 'list']);
    expect(projectKeys.detail('proj')).toEqual([BACKEND_VERSION, 'projects', 'detail', 'proj']);
    expect(projectKeys.permissions('proj')).toEqual([BACKEND_VERSION, 'projects', 'detail', 'proj', 'permissions']);
    expect(projectKeys.integrationStatus('proj')).toEqual([BACKEND_VERSION, 'projects', 'detail', 'proj', 'integration-status']);
  });
});
