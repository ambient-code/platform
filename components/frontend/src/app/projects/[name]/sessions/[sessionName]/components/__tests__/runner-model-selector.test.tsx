...
const mockGoogleModels: ListModelsResponse = {
  models: [
    { id: 'gemini-2.5-flash', label: 'Gemini 2.5 Flash', provider: 'google', isDefault: true },
...
describe('RunnerModelSelector', () => {
  ...
  it('displays Claude 4.6 models when fetched from API', () => {
    render(<RunnerModelSelector {...defaultProps} />);
    const button = screen.getByRole('button');
    // Component should have access to 4.6 models from API
