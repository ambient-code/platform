...
export default function ProjectSessionDetailPage({
  ...
  // REMOVED: streamMessages useMemo (370+ lines of custom AG-UI message transformation)
  // CopilotKit's <CopilotChat> component now handles all message display,
  // streaming, tool rendering, and conversation history. See CopilotChatPanel.tsx.

  // NOTE: The old streamMessages useMemo (370+ lines) was removed.
  // CopilotKit's <CopilotChat> handles all message display and tool rendering.
  // See CopilotChatPanel.tsx for the replacement.
  // NOTE: streamMessages useMemo (370+ lines) was removed — CopilotKit handles it.
  // See CopilotChatPanel.tsx for the replacement chat layer.
