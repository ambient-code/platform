...
var listCmd = &cobra.Command{
  ...
  acpctl inbox list --project-id <id> --pa-id <id> -o json`,
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		list, err := client.InboxMessages().List(ctx, listArgs.projectID, listArgs.paID, opts)
		if err != nil {
...
var deleteCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err := client.InboxMessages().Delete(ctx, deleteArgs.projectID, deleteArgs.paID, deleteArgs.msgID); err != nil {
