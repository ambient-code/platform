...
from .session_watch import AsyncSessionWatcher, SessionWatcher
...
class SessionAPI:
    ...
    def watch_async(self, timeout: Optional[float] = None) -> AsyncSessionWatcher:
        return AsyncSessionWatcher(self._client, timeout=timeout)
