...
type InboxMessage struct {
	...
	// Recipient — the workspace/agent address
	ProjectAgentId string `json:"project_agent_id"`
	// Sender ProjectAgent id — null if sent by a human
...
// GetProjectAgentId returns the ProjectAgentId field value
...
// GetProjectAgentIdOk returns a tuple with the ProjectAgentId field value
// and a boolean to check if the value has been set.
...
// SetProjectAgentId sets field value
func (o *InboxMessage) SetProjectAgentId(v string) {
	o.ProjectAgentId = v
}

// GetFromProjectAgentId returns the FromProjectAgentId field value if set, zero value otherwise.
func (o *InboxMessage) GetFromProjectAgentId() string {
	if o == nil || IsNil(o.FromProjectAgentId) {
		var ret string
		return ret
	}
	return *o.FromProjectAgentId
}

// GetFromProjectAgentIdOk returns a tuple with the FromProjectAgentId field value if set, nil otherwise
// and a boolean to check if the value has been set.
func (o *InboxMessage) GetFromProjectAgentIdOk() (*string, bool) {
	if o == nil || IsNil(o.FromProjectAgentId) {
		return nil, false
	}
	return o.FromProjectAgentId, true
}
...
// SetFromProjectAgentId gets a reference to the given string and assigns it to the FromProjectAgentId field.
func (o *InboxMessage) SetFromProjectAgentId(v string) {
	o.FromProjectAgentId = &v
}
...
func (o InboxMessage) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.FromProjectAgentId) {
		toSerialize["from_project_agent_id"] = o.FromProjectAgentId
	}
	if !IsNil(o.FromName) {
