...
**ProjectAgentId** | **string** | Recipient — the workspace/agent address | 
**FromProjectAgentId** | Pointer to **string** | Sender ProjectAgent id — null if sent by a human | [optional] 
...
`func NewInboxMessage(projectAgentId string, body string, ) *InboxMessage`
...
`func (o *InboxMessage) GetProjectAgentId() string`

GetProjectAgentId returns the ProjectAgentId field if non-nil, zero value otherwise.

### GetProjectAgentIdOk

`func (o *InboxMessage) GetProjectAgentIdOk() (*string, bool)`
...
`func (o *InboxMessage) SetProjectAgentId(v string)`

SetProjectAgentId sets ProjectAgentId field to given value.


### GetFromProjectAgentId

`func (o *InboxMessage) GetFromProjectAgentId() string`

GetFromProjectAgentId returns the FromProjectAgentId field if non-nil, zero value otherwise.

### GetFromProjectAgentIdOk

`func (o *InboxMessage) GetFromProjectAgentIdOk() (*string, bool)`

GetFromProjectAgentIdOk returns a tuple with the FromProjectAgentId field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.

### SetFromProjectAgentId

`func (o *InboxMessage) SetFromProjectAgentId(v string)`

SetFromProjectAgentId sets FromProjectAgentId field to given value.

### HasFromProjectAgentId

`func (o *InboxMessage) HasFromProjectAgentId() bool`

HasFromProjectAgentId returns a boolean if a field has been set.
