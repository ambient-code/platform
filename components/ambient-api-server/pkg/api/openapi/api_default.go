...
// Credential data
func (r ApiCreateCredentialRequest) Credential(credential Credential) ApiCreateCredentialRequest {
...
//
//	@return Credential
func (a *DefaultAPIService) CreateCredentialExecute(r ApiCreateCredentialRequest) (*Credential, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
...
// Credential data
func (r ApiCreateProjectCredentialRequest) Credential(credential Credential) ApiCreateProjectCredentialRequest {
	r.credential = &credential
	return r
}

func (r ApiCreateProjectCredentialRequest) Execute() (*Credential, *http.Response, error) {
	return r.ApiService.CreateProjectCredentialExecute(r)
}

/*
CreateProjectCredential Create a new credential in a project

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id The id of record
	@return ApiCreateProjectCredentialRequest
*/
func (a *DefaultAPIService) CreateProjectCredential(ctx context.Context, id string) ApiCreateProjectCredentialRequest {
	return ApiCreateProjectCredentialRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return Credential
func (a *DefaultAPIService) CreateProjectCredentialExecute(r ApiCreateProjectCredentialRequest) (*Credential, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.CreateProjectCredential")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *DefaultAPIService) DeleteCredential(ctx context.Context, credId string) ApiDeleteCredentialRequest {
	return ApiDeleteCredentialRequest{
		ApiService: a,
		ctx:        ctx,
		credId:     credId,
...
func (r ApiDeleteProjectCredentialRequest) Execute() (*http.Response, error) {
	return r.ApiService.DeleteProjectCredentialExecute(r)
}

/*
DeleteProjectCredential Delete a project credential
...
*/
func (a *DefaultAPIService) DeleteProjectCredential(ctx context.Context, id string, credId string) ApiDeleteProjectCredentialRequest {
	return ApiDeleteProjectCredentialRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
// Execute executes the request
func (a *DefaultAPIService) DeleteProjectCredentialExecute(r ApiDeleteProjectCredentialRequest) (*http.Response, error) {
	var (
		localVarHTTPMethod = http.MethodDelete
		localVarPostBody   interface{}
		formFiles          []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.DeleteProjectCredential")
	if err != nil {
		return nil, &GenericOpenAPIError{error: err.Error()}
	}
...
*/
func (a *DefaultAPIService) GetCredential(ctx context.Context, credId string) ApiGetCredentialRequest {
	return ApiGetCredentialRequest{
		ApiService: a,
		ctx:        ctx,
		credId:     credId,
...
//
//	@return Credential
func (a *DefaultAPIService) GetCredentialExecute(r ApiGetCredentialRequest) (*Credential, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
type ApiGetCredentialTokenRequest struct {
	ctx        context.Context
	ApiService *DefaultAPIService
	credId     string
}

func (r ApiGetCredentialTokenRequest) Execute() (*CredentialTokenResponse, *http.Response, error) {
	return r.ApiService.GetCredentialTokenExecute(r)
}

/*
GetCredentialToken Get a decrypted token for a credential

Returns the decrypted token value for the given credential. Requires token-reader role.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param credId The id of the credential
	@return ApiGetCredentialTokenRequest
*/
func (a *DefaultAPIService) GetCredentialToken(ctx context.Context, credId string) ApiGetCredentialTokenRequest {
	return ApiGetCredentialTokenRequest{
		ApiService: a,
		ctx:        ctx,
		credId:     credId,
...
func (a *DefaultAPIService) GetCredentialTokenExecute(r ApiGetCredentialTokenRequest) (*CredentialTokenResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.GetCredentialToken")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetProjectCredentialRequest struct {
	ctx        context.Context
	ApiService *DefaultAPIService
	id         string
	credId     string
...
func (r ApiGetProjectCredentialRequest) Execute() (*Credential, *http.Response, error) {
	return r.ApiService.GetProjectCredentialExecute(r)
}

/*
GetProjectCredential Get a project credential by id

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id The id of record
	@param credId The id of the credential
	@return ApiGetProjectCredentialRequest
*/
func (a *DefaultAPIService) GetProjectCredential(ctx context.Context, id string, credId string) ApiGetProjectCredentialRequest {
	return ApiGetProjectCredentialRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return Credential
func (a *DefaultAPIService) GetProjectCredentialExecute(r ApiGetProjectCredentialRequest) (*Credential, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.GetProjectCredential")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiGetProjectCredentialTokenRequest struct {
	ctx        context.Context
	ApiService *DefaultAPIService
	id         string
	credId     string
...
func (r ApiGetProjectCredentialTokenRequest) Execute() (*CredentialTokenResponse, *http.Response, error) {
	return r.ApiService.GetProjectCredentialTokenExecute(r)
}

/*
GetProjectCredentialToken Get a decrypted token for a project credential
...
Returns the decrypted token value for the given credential. Requires token-reader role.
	...
	@param id The id of record
	@param credId The id of the credential
	@return ApiGetProjectCredentialTokenRequest
*/
func (a *DefaultAPIService) GetProjectCredentialToken(ctx context.Context, id string, credId string) ApiGetProjectCredentialTokenRequest {
	return ApiGetProjectCredentialTokenRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return CredentialTokenResponse
func (a *DefaultAPIService) GetProjectCredentialTokenExecute(r ApiGetProjectCredentialTokenRequest) (*CredentialTokenResponse, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.GetProjectCredentialToken")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
// Maximum number of records to return
func (r ApiListCredentialsRequest) Size(size int32) ApiListCredentialsRequest {
	r.size = &size
	return r
}
...
// Specifies the order by criteria
func (r ApiListCredentialsRequest) OrderBy(orderBy string) ApiListCredentialsRequest {
	r.orderBy = &orderBy
	return r
}
...
func (r ApiListCredentialsRequest) Execute() (*CredentialList, *http.Response, error) {
	return r.ApiService.ListCredentialsExecute(r)
}

/*
ListCredentials Returns a list of credentials

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiListCredentialsRequest
*/
func (a *DefaultAPIService) ListCredentials(ctx context.Context) ApiListCredentialsRequest {
	return ApiListCredentialsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
func (a *DefaultAPIService) ListCredentialsExecute(r ApiListCredentialsRequest) (*CredentialList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
...
// Page number of record list when record list exceeds specified page size
func (r ApiListProjectCredentialsRequest) Page(page int32) ApiListProjectCredentialsRequest {
	r.page = &page
	return r
}

// Maximum number of records to return
func (r ApiListProjectCredentialsRequest) Size(size int32) ApiListProjectCredentialsRequest {
	r.size = &size
	return r
}

// Specifies the search criteria
func (r ApiListProjectCredentialsRequest) Search(search string) ApiListProjectCredentialsRequest {
	r.search = &search
	return r
}

// Specifies the order by criteria
func (r ApiListProjectCredentialsRequest) OrderBy(orderBy string) ApiListProjectCredentialsRequest {
	r.orderBy = &orderBy
	return r
}

// Supplies a comma-separated list of fields to be returned
func (r ApiListProjectCredentialsRequest) Fields(fields string) ApiListProjectCredentialsRequest {
	r.fields = &fields
	return r
}

// Filter credentials by provider
func (r ApiListProjectCredentialsRequest) Provider(provider string) ApiListProjectCredentialsRequest {
	r.provider = &provider
	return r
}
...
/*
ListProjectCredentials Returns a list of credentials for a project

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id The id of record
	@return ApiListProjectCredentialsRequest
*/
func (a *DefaultAPIService) ListProjectCredentials(ctx context.Context, id string) ApiListProjectCredentialsRequest {
	return ApiListProjectCredentialsRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return CredentialList
func (a *DefaultAPIService) ListProjectCredentialsExecute(r ApiListProjectCredentialsRequest) (*CredentialList, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.ListProjectCredentials")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
func (r ApiUpdateCredentialRequest) CredentialPatchRequest(credentialPatchRequest CredentialPatchRequest) ApiUpdateCredentialRequest {
...
*/
func (a *DefaultAPIService) UpdateCredential(ctx context.Context, credId string) ApiUpdateCredentialRequest {
	return ApiUpdateCredentialRequest{
		ApiService: a,
		ctx:        ctx,
		credId:     credId,
...
//
//	@return Credential
func (a *DefaultAPIService) UpdateCredentialExecute(r ApiUpdateCredentialRequest) (*Credential, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
...
// Updated credential data
func (r ApiUpdateProjectCredentialRequest) CredentialPatchRequest(credentialPatchRequest CredentialPatchRequest) ApiUpdateProjectCredentialRequest {
	r.credentialPatchRequest = &credentialPatchRequest
	return r
}

func (r ApiUpdateProjectCredentialRequest) Execute() (*Credential, *http.Response, error) {
	return r.ApiService.UpdateProjectCredentialExecute(r)
}

/*
UpdateProjectCredential Update a project credential
...
*/
func (a *DefaultAPIService) UpdateProjectCredential(ctx context.Context, id string, credId string) ApiUpdateProjectCredentialRequest {
	return ApiUpdateProjectCredentialRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return Credential
func (a *DefaultAPIService) UpdateProjectCredentialExecute(r ApiUpdateProjectCredentialRequest) (*Credential, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPatch
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "DefaultAPIService.UpdateProjectCredential")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
