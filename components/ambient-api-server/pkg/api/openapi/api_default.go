...
/*
ApiAmbientV1ProjectsIdAgentsGet Returns a list of project agents in a project
...
/*
ApiAmbientV1ProjectsIdAgentsPaIdDelete Remove an agent from a project

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id The id of record
	@param paId The id of the project agent
...
/*
ApiAmbientV1ProjectsIdAgentsPaIdGet Get a project agent by id
...
/*
ApiAmbientV1ProjectsIdAgentsPaIdIgnitePost Ignite a project agent — creates a Session (idempotent)

Creates a new Session for this ProjectAgent and drains the inbox into the ignition context.
...
/*
ApiAmbientV1ProjectsIdAgentsPaIdInboxGet Read inbox messages for a project agent (unread first)
...
/*
ApiAmbientV1ProjectsIdAgentsPaIdInboxPost Send a message to a project agent's inbox
...
/*
ApiAmbientV1ProjectsIdAgentsPaIdPatch Update a project agent (e.g. re-pin to a newer agent version)
...
/*
ApiAmbientV1ProjectsIdAgentsPaIdSessionsGet Get session run history for a project agent
...
/*
ApiAmbientV1ProjectsIdAgentsPost Add an agent to a project (create ProjectAgent)
...
/*
ApiAmbientV1ProjectsIdHomeGet Project home — latest status for every ProjectAgent in this project
