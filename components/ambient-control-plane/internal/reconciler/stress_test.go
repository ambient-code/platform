...
// Test configuration helpers - these would typically come from environment variables
// or test fixtures in a real implementation

func getTestAPIBaseURL() string {
	// In a real test, this would come from environment variables or test config
	// For now, return a default that can be overridden
	return "http://localhost:8000/api/ambient/v1"
}
