...
.PHONY: e2e-test e2e-setup e2e-clean deploy-langfuse-openshift kind-up-local
...
kind-up-local: check-kind check-kubectl ## Start kind cluster with locally built images
