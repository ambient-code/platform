...
# Your label: backend-tools
# Your mailbox: /Users/gkrumbac/Documents/vTeam/.claude/orchestrator/mailboxes/backend-tools

## On startup and at natural breakpoints (after commits, before PRs, when stuck):
1. Read `/Users/gkrumbac/Documents/vTeam/.claude/orchestrator/mailboxes/backend-tools/INBOX.md` for new instructions from the orchestrator
2. Act on any instructions found there

## After each significant milestone (task complete, PR created, blocker hit):
Update `/Users/gkrumbac/Documents/vTeam/.claude/orchestrator/mailboxes/backend-tools/STATUS.md` with this format:
