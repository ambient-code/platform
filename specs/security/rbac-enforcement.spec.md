...
| Credential creation is auth-exempt | Same self-service pattern as projects. Users own what they create. Binding credentials to projects requires `project:owner`, preventing unauthorized sharing. |
